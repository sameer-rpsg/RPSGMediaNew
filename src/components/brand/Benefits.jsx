...
const Benefits = () => {
  ...
  useEffect(() => {
    ...
    const splitLines = new SplitText(el, { type: "lines", linesClass: "extra-split-line" });
    const splitWords = new SplitText(splitLines.lines, { type: "lines", linesClass: "extra-split-line" });
  ...
  const benefitsData = [
    { id: "[01]", title: "The Number One Magazine" },
    { id: "[02]", title: "Produced +10,000 Assets" },
    { id: "[03]", title: "We Cut CPA With 20% On Average" },
  ];
  ...
  return (
    <div className={styles.benefits}>
      ...
      <div className={styles.benefit_subtitle_wrapper}>
        <div className={`${styles.scroll_text} ${styles._16px}`} ref={paraRef}>
          <p>
            ...
            entertainment to luxury, our brands shape conversations that
            matter. We invest deeply in every title we own, giving each one
            the focus, integrity, and creative ambition it deserves—
            building media that endures, not just performs.
          </p>
          <br />
          <p>
            Since our inception, we've brought together globally respected
      ...
      <div className={styles.benefits_content_wrapper}>
        {/* === Left Video === */}
        <div className={styles.left_embed_wrapper}>
          <div className={`${styles.embed_video} ${styles._50} ${styles.w_embed}`}>
            <video
              autoPlay
              muted
              loop
        ...
        <div className={styles.right_content_wrapper}>
          <div className={styles.content_container}>
            {benefitsData.map(({ id, title }, index) => (
                      <FadeSpan delay={index * 200}>
